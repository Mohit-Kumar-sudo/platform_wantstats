...
@Component({
  selector: 'app-hardcode-suggestion',
  templateUrl: './hardcode-suggestion.component.html',
  styleUrls: ['./hardcode-suggestion.component.scss'],
})
export class HardcodeSuggestionComponent implements OnInit {
