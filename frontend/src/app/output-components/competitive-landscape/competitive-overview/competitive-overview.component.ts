...
@Component({
  selector: 'app-competitive-overview',
  templateUrl: './competitive-overview.component.html',
  styleUrls: ['./competitive-overview.component.scss']
})
export class CompetitiveOverviewComponent implements OnInit {
  ...
  getReportDetailsSuccess(data: any) {
    if (data && data.length) {
      data.forEach(d => {
        if (d.meta_info.section_key === 'overview') {
