...
@Component({
  selector: 'app-competitive-merger-and-acquisition-output',
  templateUrl: './competitive-merger-and-acquisition-output.component.html',
  styleUrls: ['./competitive-merger-and-acquisition-output.component.scss']
})
export class CompetitiveMergerAndAcquisitionOutputComponent implements OnInit {
  ...
  getReportDetailsSuccess(data: any) {
    if (data && data.length) {
      data.forEach(d => {
        if (d.meta_info.section_key === 'mergerAndAquisition') {
