...
@Component({
  selector: 'app-mi-market-study-of-scope',
  templateUrl: './mi-market-study-of-scope.component.html',
  styleUrls: ['./mi-market-study-of-scope.component.scss']
})
export class MiMarketStudyOfScopeComponent implements OnInit {
  ...
  getReportDetailsSuccess(data: any) {
    if (data && data.length) {
      data.forEach(d => {
        if (d.meta_info.section_key === 'scope') {
          this.secondaryOutputModel = {
            ...
            heading : "Scope of the study, Market Introduction"
          }
        }
